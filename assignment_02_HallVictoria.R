...
voter_turnout_df1 <- read_excel('data/G04ResultsDetail2004-11-02.xls',sheets='Voter Turnout')
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls',sheet='Voter Turnout',colnames="ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
